...
ACCURACY_SPECS = [
    ...
    dict(family="uma", checkpoint="uma-s-1", regime="batch vs separate / fairchem",
         module="tests/test_batch.py", golden="batch_ethanol_omol.npz"),
    ...
    dict(family="orb", checkpoint="conservative + direct",
         regime="batch vs separate / public calculator",
         module="tests/test_orb_evaluate_batch.py",
    ...
    dict(family="orb", checkpoint="direct-20-omat",
         regime="ZBL short-contact energy/forces/stress",
