...
Run:  python benchmarks/bench_compile_pain.py --card 0
"""
...
from _harness import (cache_stats, git_sha, orb_weights, sandbox_env, take_lease,
                      ttnn_version, wait_for_quiet)
...
def run_leg(weights, systems, home, tag, card):
    ...
    return dict(tag=tag, wall_s=round(wall, 2), git_sha=git_sha(),
                ttnn_version=ttnn_version(), cache_files_before=files0,
